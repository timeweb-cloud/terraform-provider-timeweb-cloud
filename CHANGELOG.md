...
* fix: добавлена зона доступности в пресеты и более ясная ошибка при несовпадении пресета с зоной
* fix: удаления файрвола
* fix: невозможность создать LAN сеть на некоторых пресетах конфигуратора
* fix: внутренние улучшения для возможности замены defaultBaseUrl для API-вызовов на stage и dev
