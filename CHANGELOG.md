...
# [v1.7.2] - 16.06.2026
## Chored
* Минорные обновления провайдера

# [v1.7.1] - 09.06.2026
## Chored
* Обновление DTO роутеров и K8S
## Added
* Добавлен ресурс для генерации рандомных строк

# [v1.7.0] - 03.06.2026
## Chored
* Обновление версии Go до 1.26
## Fixed
* Поправлена работа с контекстами и их прерываниями
* Обновление deprecated частей проекта
* Поправлен мутирующий URI для запросов
## Added
* Добавлены retries & timeouts для методов
* Изменен ресурс виртуальных роутеров

# [v1.6.16] - 06.05.2026
## Fixed
* Поправлено создание ресурса роутеров и переход на публичные IP для K8S, и обратно

# [v1.6.15] - 24.04.2026
## Fixed
* Поправлено нулевое значение в поле min_size для скейлера кластера K8S

# [v1.6.14] - 22.04.2026
## Fixed
* Поправлена работа со скейлером в группах нод
* Поправлена работа с аддонами для кластера K8S

# [v1.6.13] - 03.04.2026
## Fixed
* Поправлено поле NAT в роутерах вызывающее пересоздание ресурса при каждом apply

# [v1.6.12] - 05.03.2026
## Added
* Добавлена поддержка виртуальных роутеров
* Добавлена поддержка виртуальных роутеров в Kubernetes

# [v1.6.11] - 12.02.2026
## Added
* В серверах добавлены все зоны доступности и локации
## Fixed
* Исправлено падение на данных плавающих IP
...
# [v1.6.9] - 19.01.2026
## Added
* Добавлена работа с окном обслуживания и OIDC провайдером для Kubernetes

# [v1.6.8] - 23.12.2025
## Added
* Возможность установки и смены hostname VDS

# [v1.6.7] - 25.10.2025
## Fixed
* Исправлено содание кластера, добавлено ожидание перед Kubeconfig
...
# [v1.6.5] - 01.08.2025
## Added
* Обновление определения версии кластера K8S

# [v1.6.4] - 01.08.2025
## Added
* Обновление версии кластера K8S без перегенерации 
